...
@section('content')
    ...
    <div class="container">
      ...
      {!! Form::model($leader, ['method'=>'PATCH', 'action'=> ['MpmlaController@update', $leader->id],'files'=>true]) !!}
            ...
            <div class="form-group">
                ...
                <br>
                <img src="{{$leader->photo ? asset('public/backend/images/leaders')."/".$leader->photo : 'http://placehold.it/400x400'}}" width="100px" height="100px" class="rounded-circle" alt="image" />
