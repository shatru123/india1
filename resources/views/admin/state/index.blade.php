...
@section('content')
        ...
        <div class="container">
            ...
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>States</h4>
        <h5 class="hk-pg-title">
            <a href="{{route('state.create')}}"><span class="pg-title-icon"><span class="feather-icon">
                        ...
                        @if($states)
                            ...
                            @foreach($states as $state)
                                    <tr>
                                        ...
                                        <td>{{$state->name}}</td>
                                        <td>
                                            <a href="{{route('state.edit',$state->id)}}" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="icon-pencil"></i> </a>
