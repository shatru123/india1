    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            ...
            <h5 class="hk-pg-title">
                <a href="{{route('news.create')}}"><span class="pg-title-icon"><span class="feather-icon">
                                ...
                                @if($newss)
                                    ...
                                    @foreach($newss as $news)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{$news->image ? asset('public/backend/images/news')."/".$news->image : 'http://placehold.it/400x400'}}" width="100px" height="100px"  class="table-hover"   />
                                            </td>
                                            <td>{{$news->title}}</td>
                                            <td>{{$news->location}}</td>

                                            <td>
                                                <a href="{{route('news.edit',$news->id)}}" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="icon-pencil"></i> </a>
