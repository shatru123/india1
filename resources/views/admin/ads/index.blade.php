    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon">
                    <span class="feather-icon"><i data-feather="database"></i></span></span>Ads</h4>
            <h5 class="hk-pg-title">
                <a href="{{route('ads.create')}}"><span class="pg-title-icon"><span class="feather-icon">
                                ...
                                @if($ads)
                                    ...
                                    @foreach($ads as $ad)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{$ad->image ? asset('public/backend/images/ads')."/".$ad->image : 'http://placehold.it/400x400'}}" width="100px" height="100px"  class="table-hover"   />
                                            </td>
                                            <td>{{$ad->title}}</td>
                                            <td>{{$ad->location}}</td>

                                            <td>
                                                <a href="{{route('ads.edit',$ad->id)}}" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="icon-pencil"></i> </a>
