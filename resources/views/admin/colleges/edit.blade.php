    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title">
                <span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Edit College Details</h4>
        </div>

        <section class="hk-sec-wrapper">

            {!! Form::model($college, ['method'=>'PATCH', 'action'=> ['CollegeController@update', $college->id],'files'=>true]) !!}
            ...
            <div class="form-group">
                {!! Form::submit('Edit College Details', ['class'=>'btn btn-primary']) !!}
            </div>
